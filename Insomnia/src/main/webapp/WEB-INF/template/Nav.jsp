					...
					<div class="nav">
						<ul class="group" id="header-menu-magic-line">
							...
							<li class="menu-item-has-children"><a
								...
								<ul class="sub-menu">
									<li><a href="<c:url value='/main/mainproject.ins'/>">Main
											Projects</a></li>
									<li><a href="<c:url value='/sub1/subprojects.ins'/>">Sub
											Projects</a></li>
								</ul></li>
							<%
						...
						if (response.status === 'connected') {
							...
							FB.api('/me', {
								...
								if (response && !response.error) {
									...
									console.log("받은 json 객체"
											+ JSON.stringify(response));
									$('#socialName').prop('value',
											response.name);
									$('#socialEmail').prop('value',
											response.email);
									$('#socialBirth').prop('value',
											response.birthday);
									$('#socialProfile').prop('value',
