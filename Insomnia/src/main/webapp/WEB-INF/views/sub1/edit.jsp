...
<link rel="stylesheet"   href="<c:url value='/vendor/css/bootstrap2.min.css'/>">
<script src="<c:url value='/vendor/js/jquery2.js'/>"></script>
<script src="<c:url value='/vendor/js/bootstrap2.min.js'/>"></script>


<!-- 섬머노트 css,js -->
<link rel="stylesheet"   href="<c:url value='/vendor/css/summernote.css'/>" type="text/css">
<script src="<c:url value='/vendor/js/summernote.js'/>"></script>
<!-- 섬머노트 awesome css,js -->
<link rel="stylesheet"   href="<c:url value='/vendor/css/summernote-ext-emoji-ajax.css'/>" type="text/css">
      ...
      <section class="single-product">
         <div class="container">
            ...
            <div role="tabpanel" class="container">
               <div class="row">
                  <div class="col-md-12">
                     <form class="form-horizontal" id="frm" method="post" action="<c:url value='/sub1/write.ins'/>">
                        <div class="form-group">
                           <input type="hidden" name="ap_no" value="${record.ap_no}" /> 
									<label for="ap_title" class="col-sm-2 control-label">제목</label>
                           <div class="col-sm-5">
                              <input type="text"  value="${record.ap_title}" class="form-control" name="ap_title" id="ap_title" placeholder="제목을 입력하세요" />
                           </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-5">
                              <textarea rows="10" id="summernote" name="ap_content" class="form-control"   placeholder="내용을 입력하세요">${record.ap_content}</textarea>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-12 text-center">
                              <input type="submit" class="btn btn-info" value="등록" />
                              <a   href="<c:url value='/sub1/subcontent.ins'/>" class="btn btn-success">취소</a>
                           </div>
                        </div>
                     </form>
                  </div>
