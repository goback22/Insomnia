            ...
            <div class="section__content">
               ...
               <div class="menu-content">
                  ...
                  <div class="columns">
                     ...
                     <div class="column q-1-5">
                        <span class="line"></span> <a href="mailto:hello@clorova.com"
         ...
         <div id="main" class="q_horizontal">
            <div class="works-wrapper">
               <a href="#" class="works-item hover-target">
                  ...
                  <span></span> 06</date>
                  <figure class="image-container">
                     <div class="work-image-wrapper vsh" data-speed="-.1" style="display: none">
                        <div class="work-image"
                  ...
                  <figure class="image-container">
                     <div class="work-image-wrapper vsh" data-speed="-.1">
                        <div class="work-image"
                           style="background-image: url('/insomnia/resource/img/bgs.jpg')">
                           <img src="assets/img/works/mowilex/bgs.jpg"
                              alt="Mowilex by Clorova" />
                        </div>
                     </div>
                  </figure>
                  <div class="text vsh" data-speed=".2">
               ...
               </a> <a href="works/the-acala.html" class="works-item hover-target">
                  <date>04 <span></span> 06</date>
                  <figure class="image-container">
                     <div class="work-image-wrapper vsh" data-speed="-.1">
                        <div class="work-image"
                           style="background-image: url('/insomnia/resource/img/thumb.jpg')">
                           <img src="assets/img/works/acala/thumb.jpg"
                              alt="The Acala by Clorova" />
                        </div>
                     </div>
                  </figure>
                  <div class="text vsh" data-speed=".2">
                     <h5>Bali — 2018</h5>
                     <h1>The Acala</h1>
                     <p>Photography — Interior</p>
                  </div>
               </a> <a href="works/jannata.html" class="works-item hover-target">
                  <date>05 <span></span> 06</date>
                  <figure class="image-container">
                     <div class="work-image-wrapper vsh" data-speed="-.1">
                        <div class="work-image"
                           style="background-image: url('/insomnia/resource/img/thumb.jpg')">
                           <img src="assets/img/works/jannata/thumb.jpg"
                              alt="Jannata Resorts by Clorova" />
                        </div>
                     </div>
                  </figure>
                  <div class="text vsh" data-speed=".2">
               ...
               </a> <a href="works/pnk-hotels.html" class="works-item hover-target">
                  <date>06 <span></span> 06</date>
                  <figure class="image-container">
                     <div class="work-image-wrapper vsh" data-speed="-.1">
                        <div class="work-image"
                           style="background-image: url('/insomnia/resource/img/thumb.jpg')">
                           <img src="assets/img/works/pnk/thumb.jpg"
                              alt="PNK Hotels by Clorova" />
                        </div>
                     </div>
                  </figure>
                  <div class="text vsh" data-speed=".2">
