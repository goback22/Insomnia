...
<body>
	...
	<div id="site">
		...
		<div>
			<!-- Section  -->
			<section id="artist" class="section-padding section-dark parallax-window"
				data-parallax="image"
				...
				<div class="container" style="margin-top: 5%;">
					<div class="section-title text-center">
						<h2>밴드 이름 <input type="text" name="b_name" id="b_name" class="b_name" required></h2>
					</div>
					<!-- /.section-title -->
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-full-width">
							<div class="artist-image">
								<div class="single-show-archive" style="margin-top:45px;">
									<img id="bi_profile" src="<c:url value='/resource/img/default_band_profile_img.jpg'/>" alt="artist">
									<a href="javascript:upload('profile');" data-toggle="modal" data-target="#modal_profile" ><i class="fa fa-link" aria-hidden="true" title="프로필 이미지 설정"></i></a>
								</div>
							</div>
							<!-- /.artist-image -->
						</div>
						...
						<div class="col-lg-6 col-md-6 col-full-width">
							<div class="artist-details">
								<h3 class="artist-name"><input type="text" name="b_description" id="b_description" class="b_desciption"></h3>
								<h4 class="band-name">밴드 주 설명</h4>

								<div class="details">
									<h3>About Me</h3>

									<textarea name="b_banner_description" id="b_banner_description" class="b_banner_description" style="width:700px; height:300px;"></textarea>
	      ...
	      <div id="modal_profile" class="modal fade">
	         <div class="modal-dialog">
	            <div class="modal-content">
	               ...
	               <br/>
	               <form name="frm_profile" id="frm_profile" method="post" accept="image/*" action="<c:url value='/bandsubmit/setprofile.ins'/>" enctype="multipart/form-data">
	                  	<input type="file" id="upload_profile" name="upload_profile">
	               </form>
	                  <br/><br/>
	                  <p style="color:gray;">
	                     ※ 이미지를 설정하면 배너 전체 이미지도 동일하게 설정됩니다.
	                  </p>
	               </div>
								...
								<div class="show-archive-wrapper row no-gutters" style="">
									<div class="offset-xs-0 offset-sm-4 col-sm-4 col-6">
										<div class="single-show-archive">
											<img id="image1" src="<c:url value='/media/album/18.jpg'/>" alt="">
											<a  href="javascript:void(0)" data-toggle="modal" data-target="#modal_images"><i class="fa fa-link" aria-hidden="true"></i>
											</a>
											<input id="asd" type="file" hidden="hidden">
										</div>
									</div>
									<div class="col-6 col-sm-4">
										<div class="single-show-archive">
											<img id="image2" src="<c:url value='/media/album/19.jpg'/>" alt="">
											<a  href="javascript:void(0)" data-toggle="modal" data-target="#modal_images"><i class="fa fa-link" aria-hidden="true"></i>
											</a>
										</div>
									</div>
									<div id="padding-div" class="col-xs-12 col-sm-8"
										...
										<div class="single-show-archive">
											<a href="javascript:upload('video');"><i
												class="fa fa-link" aria-hidden="true" title="밴드 비디오 등록"></i></a> <img
												id="video_img_url"
									...
									<div class="col-12 col-sm-4">
										<div class="single-show-archive">
											<img id="image3" src="<c:url value='/media/album/21.jpg'/>" alt="">
											<a  href="javascript:void(0)" data-toggle="modal" data-target="#modal_images"><i class="fa fa-link" aria-hidden="true"></i></a>
										</div>
									</div>
								</div>
								<!-- /.row -->
	      ...
	      <div id="modal_images" class="modal fade">
	         <div class="modal-dialog">
	            <div class="modal-content">
	               ...
	               <br/>
	                  <form name="frm_images" id="frm_images"  method="post" accept="image/*" action="<c:url value='/bandsubmit/setimages.ins'/>" enctype="multipart/form-data" style="text-align:center;">
	                  ...
	                  <br/><br/>
	                  <p style="color:gray;">
	                     ※ 이미지를 설정하지 않으면 기본 이미지 그대로 게시됩니다.
	                  </p>
	               </div>
	               <div class="modal-footer">
	               	  <button id="btn_setImages" class="btn btn-info" type="button" data-dismiss="modal">확인</button>
	                  <button type="button" class="btn btn-light" data-dismiss="modal">닫기</button>
	               </div>
	            </div>
	         </div>
				...
				<div class="col-lg-8 col-md-8">
					<article class="blog-post-list">
						...
						<div class="entry-content-wrapper">
							...
							<textarea class="content-textarea">추후 네이버 2.0 에디터로 대체</textarea>
							...
							<div class="rightinfo-reward-list" style="width: 100%;"
								...
								<div class="top-info" style="width: 100%">
									...
									<div class="watch-inner text-center reward-list-button-footer">
										<a href="javascript:add();" id="add" class="tim-btn tim-btn-bg">ADD</a>
										<a href="javascript:remove();" id="delete" class="tim-btn tim-btn-bg">DEL</a>
									</div>
		...
		var upload = function(way) {
     	 ...
     	 $(function(){
				...
				$('#setprofile').on("click",function(){
					...
					var extensionPos = $("#upload_profile").val().lastIndexOf('.')+1;
					var extension = $("#upload_profile").val().substring(extensionPos);
					console.log("확장자 = " + extension);
					
					var match = ['jpg', 'png', 'gif', 'jpeg', 'bmp', 'tif'];
					
					console.log("타입은 대체?" + $("#upload_profile").type);
					...
					if(uploadOk) {
						$('#frm_profile').ajaxForm({
							...
							success : function(data){
								console.log(data);
								$("#artist").css("background-image", "url('/insomnia/upload/temp/"+data+"')");
								$("#artist").attr("data-bg-image", "/insomnia/upload/temp/"+data);
								$("#artist").removeAttr("data-bg-image");
								$("#bi_profile").get(0).src = "/insomnia/upload/temp/" + data;
								console.log($("#artist").attr("data-image-src"));
							},//success
