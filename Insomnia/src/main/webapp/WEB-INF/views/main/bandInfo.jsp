...
<script
	src="https://ajax.aspnetcdn.com/ajax/jquery.migrate/jquery-migrate-3.0.0.min.js"></script>
...
<!-- light box jquery -->
<link rel="stylesheet"
	href="<c:url value='/vendor/css/lightgallery.min.css'/>">
						...
						<div class="mypage-project bg ">
							...
							<div class="tab-list">
								<div class="insert-underbar-div">
									<ul id="historyTab">
										<li class="active"><span id="card-funding"
											style="color: rgba(0, 0, 0, .84); border-bottom: none;">펀딩한</span></li>
										<!-- 결제 -->
									...
									<div class="lightgallery-div">
										<div class="lightgallery-center-div">
											...
											<div class="lightgallery" id="lightgallery">
												<a href="<c:url value='/upload/temp/a.jpg'/>"> <img
													class="thumbnail" src="<c:url value='/upload/temp/a.jpg'/>" />
												</a>
											</div>

											<div class="lightgallery" id="lightgallery">
												<a href="<c:url value='/upload/band/img/1.jpg'/>"> <img
													class="thumbnail"
													src="<c:url value='/upload/band/img/1.jpg'/>" />
												</a>
											</div>

											<div class="lightgallery" id="lightgallery">
												<a href="<c:url value='/upload/band/img/2.png'/>"> <img
													class="thumbnail"
													src="<c:url value='/upload/band/img/2.png'/>" />
												</a>
											</div>

											<div class="lightgallery" id="lightgallery">
												<a href="<c:url value='/upload/temp/b.jpg'/>"> <img
													class="thumbnail" src="<c:url value='/upload/temp/b.jpg'/>" />
												</a>
											</div>

											<div class="lightgallery" id="lightgallery">
												<a href="<c:url value='/upload/temp/c.jpg'/>"> <img
													class="thumbnail" src="<c:url value='/upload/temp/c.jpg'/>" />
												</a>
											</div>

											<div class="lightgallery" id="lightgallery">
												<a href="<c:url value='/upload/temp/d.jpg'/>"> <img
													class="thumbnail" src="<c:url value='/upload/temp/d.jpg'/>" />
												</a>
											</div>

											<div class="lightgallery" id="lightgallery">
												<a href="<c:url value='/upload/temp/e.jpg'/>"> <img
													class="thumbnail" src="<c:url value='/upload/temp/e.jpg'/>" />
												</a>
											</div>

											<div class="lightgallery" id="lightgallery">
												<a href="<c:url value='/upload/temp/f.jpg'/>"> <img
													class="thumbnail" src="<c:url value='/upload/temp/f.jpg'/>" />
												</a>
											</div>
											<!-- 여기부터 이미지 추가 끝 -->

											<!-- 새로운 이미지를 등록하는 다이브 -->
											<div data-toggle="modal" data-target="#modal-upload-img"
												class="plus-image"
												style="display: inline-block; width: 287px; height: 287px; text-align: center; padding-top: 125px; margin: 0 0 20px 20px; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.5);">
												<img style="width: 30px; height: 30px;"
													src="<c:url value='/resource/img/plus-button.png'/>" />
											</div>
											<!-- 새로운 이미지를 등록하는 다이브 끝 -->
										</div>
									</div>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<br />
												<form name="frm-band-img" id="frm-band-img" method="post"
													accept="image/*"
													action="<c:url value='/band/uploadBandImageInBandInfo.ins'/>"
													enctype="multipart/form-data">
													<input type="file" id="upload_band_img"
														name="upload_band_img">
												</form>
												<br />
												<br />
												<p style="color: gray;">※ 새로운 밴드 이미지를 등록해 주세요.</p>
											</div>
											<div class="modal-footer">
												<button class="btn btn-info" id="add-band-img"
										...
										<div class="container">
											<div class="tab-filter-wraper">
												<ul class="tim-isotope-filter tabs-filter-button">
													...
													<li><a href="" data-filter=".folk-pop">포크·팝</a></li>
													<li><a href="" data-filter=".jazz-classic">재즈·클래식</a>
													</li>
													<li><a href="" data-filter=".hiphop">힙합</a></li>
													<li><a href="" data-filter=".dance-electronic">댄스·일렉트로닉</a>
													</li>
													<li><a href="" data-filter=".rock-metal">락·메탈</a></li>
													<li><a href="" data-filter=".traditional">국악</a></li>
												</ul>
												...
												<div class="tim-isotope tim-isotope-3">
													<ul id="music-list"
														class="tim-filter-items tabs-filter grid">
														<li class="grid-sizer"></li>

														<!-- 리스트 추가 시작 -->
														<li
															class="tim-songs-items grid-item rock-metal dance-electronic">
														...
														<li
															class="tim-songs-items grid-item rock-metal dance%electronic folk-pop">
															<ul class="songs-details">
														...
														<li
															class="tim-songs-items grid-item rock-metal dance%electronic jazz-classic">
															<ul class="songs-details">
														...
														<li
															class="tim-songs-items grid-item jazz-classical dance-electronic">
															<ul class="songs-details">
														...
														<li
															class="tim-songs-items grid-item hiphop dance-electronic ">
															<ul class="songs-details">
																<li>Lose yourself</li>
																<li>Rap</li>
																<li>play</li>
														...
														<!-- 새로운 넘버를 추가하는 div -->
														<!-- 밴드 멤버 본인만 보여줘야 한다. -->
														<li id="add-music-li" class="tim-songs-items grid-item"
															data-toggle="modal" data-target="#modal-upload-music">
															<ul class="songs-details">
																<li><img style="width: 22px;"
																	src="<c:url value='/resource/img/plus-button.png'/>"></li>
																<li><img style="width: 22px;"
																	src="<c:url value='/resource/img/plus-button.png'/>"></li>
																<li><img style="width: 22px;"
																	src="<c:url value='/resource/img/plus-button.png'/>"></li>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<br />
												<form name="frm-band-music" id="frm-band-music"
													method="post" accept="image/*"
													action="<c:url value='/band/uploadBandMusicInBandInfo.ins'/>"
													enctype="multipart/form-data">
													...
													<div class="upload-music-div">
														<!-- 음악 타이틀 -->
														<label style="margin-bottom: 0; padding-left: 20px;">
															타이틀 <input class="new-music-title" id="title"
															name="title" type="text">
														</label>
														<!-- 업로드할 파일 -->
														<input style="width: 80px;" type="file"
															id="upload_band_music" name="upload_band_music">
													</div>
												</form>
												<br />
												<br />
												<p style="color: gray;">※ 새로운 밴드 음악을 등록해 주세요.</p>
											</div>
											<div class="modal-footer">
												<button class="btn btn-info" id="add-band-music"
													data-dismiss="modal">확인</button>
												<button type="button" class="btn btn-light"
													data-dismiss="modal">닫기</button>
											</div>
	...
	<script>
		...
		function addBandImg(path) {
			...
			$(".lightgallery-center-div").html(
					beforeString + afterString + addDiv);
			...
			$
					.each(
							...
							function(index, element) {
								...
								afterString += '<li>' + element['title']
										+ '</li>';
								afterString += '<li>' + element['category']
										+ '</li>';
