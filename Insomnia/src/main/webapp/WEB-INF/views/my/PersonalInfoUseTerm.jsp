<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    본인은 인섬니아(이하 ‘회사’라 합니다)가 제공하는 회원 서비스(이하 ‘서비스’라 합니다)를 이용하기 위해, 다음과 같이 ‘회사’가 본인의 개인정보를 수집/이용하고, 개인정보의 취급을 위탁하는 것에 동의합니다.

※ 귀하께서는 개인정보 수집·이용·취급위탁에 대한 동의를 거부하실 수 있으나, 동의를 거부하실 경우 회원가입, 서비스 이용 등을 하실 수 없습니다.

1. 개인정보 항목·목적·보유기간
구분	필수
항목	성명, 생년월일, 성별, 아이디,비밀번호, 휴대전화번호,E-Mail
목적	- 회원가입(홈페이지. 마이 인섬니아 리워드), 본인확인
- 서비스 제공
