		...
		<br><br><br><br>
			...
			<div class="allWrap">
				...
				<form class="editForm" method="POST" action="">
					...
					<input type="text" name="editEmail" id="editEmail" readonly value="${record.email}">
					<div id="editEmailBtn">변경</div>
					<input type="text" name="editPhone" id="editPhone" value="${record.phone}">
					<div id="editAuthBtn">인증하기</div>
					<p class="title2">주소 변경</p>
					<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기" class="addrBtn"><br>
					<input type="text" id="sample4_postcode" placeholder="우편번호" class="addr1">
					<input type="text" id="sample4_roadAddress" placeholder="도로명주소" class="addr2">
				<!-- 	<input type="text" id="sample4_jibunAddress" placeholder="지번주소" class="addr3"> -->
					...
					<input type="text" id="sample4_detailAddress" placeholder="상세주소" class="addr5">
					
					<p class="title1">마케팅 정보 수신 동의</p>
					<div class="marketingDiv">
						<input type="radio" name="setMarketing" id="setMarketingEmail">이메일
						<input type="radio" name="setMarketing" id="setMarketingSMS">SMS
					</div>
