...
var $config = {};
	$config.domain			   = 'http://www.istarbucks.co.kr/15th/';
	$config.ssl 			   = 'https://www.istarbucks.co.kr/15th/';
...
$(document).ready(function(){
	...
	{
		location.href='http://www.istarbucks.co.kr';
	}
	...
	loginHtml  += '  		<a class="login_layer_close" href="javascript:void(0);">�リ린</a>   ';
	loginHtml  += '  	</header>   ';
	...
	loginHtml  += '  		   ';
	loginHtml  += '  			<p class="login_greet_txt"><strong>Welcome! �ㅽ�踰낆뒪而ㅽ뵾 肄붾━�꾩뿉 �ㅼ떊 寃껋쓣 �섏쁺�⑸땲��.</strong><br>�ㅼ젙�섏떊 �꾩씠�붿� 鍮꾨�踰덊샇瑜� �낅젰�� 二쇱꽭��.</p>   ';
	loginHtml  += '  			<fieldset class="login_field">   ';
	loginHtml  += '  				<legend class="hid">濡쒓렇�� �꾩씠��, 鍮꾨�踰덊샇 �낅젰��</legend>   ';
	...
	loginHtml  += '  						<label for="idRemb">�꾩씠�� ����</label>   ';
	loginHtml  += '  					</aside>   ';
	loginHtml  += '  					<a class="btn_login" href="javascript:void(0);">濡쒓렇��</a>   ';
	loginHtml  += '  				</div>   ';
	loginHtml  += '  			</fieldset>   ';
	loginHtml  += '  			   ';
	loginHtml  += '  			<p class="reg_chg_pw_warn" style="display:none;">* �� �ъ씠�몄� 鍮꾨�踰덊샇瑜� �숈씪�섍쾶 �ъ슜�� 寃쎌슦 �꾩슜�� �꾪뿕�� �덉쑝誘�濡�, �뺢린�곸씤 鍮꾨�踰덊샇 蹂�寃쎌쓣 �댁＜�쒓만 諛붾엻�덈떎.</p>   ';
	loginHtml  += '  			<p class="captcha_guide" style="display:none;">鍮꾨�踰덊샇瑜� 5�� �댁긽 �섎せ �낅젰�섎㈃, 蹂댁븞臾몄옄瑜� �④퍡 �낅젰�섏뀛�� �⑸땲��. �꾨옒 �대�吏��� 蹂댁븞臾몄옄瑜� 蹂댁씠�� ��濡� �낅젰�댁＜�몄슂.</p>   ';
	loginHtml  += '  			<fieldset class="captcha_field" style="display:none;">   ';
	loginHtml  += '  				<legend class="hid">蹂댁븞臾몄옄 �낅젰��</legend>   ';
	loginHtml  += '  				<div class="captcha_input_wrap">   ';
	loginHtml  += '  					<dl>   ';
	loginHtml  += '  						<dt>蹂댁븞臾몄옄</dt>   ';
	loginHtml  += '  						<dd>   ';
	loginHtml  += '  							<p class="captcha_img"><img alt="" /></p>   ';
	loginHtml  += '  							<a class="btn_login btn_new_captcha" href="javascript:void(0);">�덈줈<br>怨좎묠</a>   ';
	...
	loginHtml  += '  				<p class="login_help_txt"><strong>�ㅽ�踰낆뒪而ㅽ뵾 肄붾━�� �뚯썝�� �꾨땲�몄슂?</strong><br>�ㅽ�踰낆뒪而ㅽ뵾 肄붾━�� �뚯썝留뚯쓽 �밸퀎�� �쒗깮�� �꾨┫ �� �덉뒿�덈떎.</p>   ';
	loginHtml  += '  				<a href="/mem/join.do">�뚯썝媛���</a>   ';
	loginHtml  += '  			</div>   ';
	loginHtml  += '  			<div class="forget_idpw">   ';
	loginHtml  += '  				<p class="login_help_txt"><strong>怨좉컼��! �꾩씠��, 鍮꾨�踰덊샇瑜� �딆쑝�⑤굹��?</strong><br>怨좉컼�섏쓽 蹂몄씤 紐낆쓽 �대��� �몄쬆 �먮뒗 �꾩씠�� �몄쬆�쇰줈 李얠쓣 �� �덉뒿�덈떎.</p>   ';
	loginHtml  += '  				<a href="/mem/find_mem1.do">�꾩씠�� 쨌 鍮꾨�踰덊샇 李얘린</a>   ';
	loginHtml  += '  			</div>   ';
	loginHtml  += '  		</form>   ';
...
function getPattern(type)
{
	  switch(type)
	  {
	    ...
	    case "BASIC2":  //�쒓� �レ옄 �곸뼱留�
	    	pattern =  /^[��-��|媛�-��|a-z|A-Z|0-9|\*-_.]+$/;
	    	break;	    	
	    	
	    case "BASIC3":  //�쒓� �レ옄 �곷Ц �뱀닔臾몄옄 !@#?$%&*��{.,<>
	    	pattern = /^[��-��|媛�-��|a-z|A-Z|0-9|\s!@#?:$%&*().\r\n,<>\*]+$/;
	    	break;		    	
	   
		case "BASIC4":  //�レ옄 �곷Ц �뱀닔臾몄옄_ - .
	    ...
	    case "HOST": //�곸옄	�� '-'
	    	pattern = /^[a-zA-Z-]+$/;
	    	break;
	    case "ID": //泥リ��먮뒗 �곸옄 洹� �ㅼ뿏 �곸뼱�レ옄 6�댁긽 15�먮━	�댄븯
	    	//pattern = /^[a-zA-Z]{1}[a-zA-Z0-9_-]{5,15}$/;
	    	pattern = /^[a-zA-Z]{1}[a-zA-Z0-9]{5,15}$/;
	    	break;

	    case "ID2": //泥リ��먮뒗	�곸옄 洹몃뮘��	�곸뼱�レ옄 4�댁긽 15�먮━	�댄븯
	    	pattern = /^[a-zA-Z0-9._-]+$/;
	    	break;

	    case "DATE": //	�뺤떇 : 2002-08-15
...
function chkPattern(str,type)	//�뺤떇 泥댄겕
{
  switch(type)
  {
    case "NUM": //�レ옄留�
...
(function($){
	...
	var a=/a/i,defs={
		item		: 'li',
		next		: '<a href="javascript:void(0)"><img alt="�욎쑝濡�" src="//image.istarbucks.co.kr/common/img/util/ec/next.jpg"></a>'		,
		prev		: '<a href="javascript:void(0)"><img alt="�욎쑝濡�" src="//image.istarbucks.co.kr/common/img/util/ec/prev.jpg"></a>'		,
		...
		href			: '#'							,
		event		: true							,
		first			: '<a href="javascript:void(0)"><img alt="泥섏쓬�쇰줈" src="//image.istarbucks.co.kr/common/img/util/ec/first.jpg"></a>'							,
		last			: '<a href="javascript:void(0)"><img alt="�앹쑝濡�" src="//image.istarbucks.co.kr/common/img/util/ec/last.jpg"></a>'
	},format=function(str){
		var arg=arguments;
...
var Cookies = {
		...
		getCookie : function(name){						//荑좏궎媛� 媛��몄삤湲�
		...
		deleteCookie : function(cookieName){		//荑좏궎媛� ��젣�섍린
		...
		setCookie : function(name, value, expiredays){		//荑좏궎媛� �곸슜�섍린
