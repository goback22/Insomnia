...
<head>
<meta charset="UTF-8">
<link href="<c:url value='/ProjectCSS/TermCSS.css'/>" rel="stylesheet"/>
						...
						<div class="privacy_cont">
							<p class="title_text" id="title_text">
								...
								<meta property="og:image"
									content="http://www.istarbucks.co.kr/common/img/kakaotalk.png">
								<meta property="og:description" content="Starbucks"> -->

								<title>Starbucks Coffee Korea</title>
								<!-- <link rel="shortcut icon"
									href="https://www.istarbucks.co.kr/common/img/common/favicon.ico"
									type="image/ico">
								<link href="https://www.istarbucks.co.kr/common/css/reset.css"
									rel="stylesheet">
								<link href="https://www.istarbucks.co.kr/common/css/style.css"
									rel="stylesheet"> -->
							...
							<div id="popWrap">
								...
								<div id="container">
									...
									<div class="privacy_cont">
										...
										<p class="mb40">'이용자”란 회사 홈페이지에 접속하여 본 약관에 따라 회사 인터넷 회원으로
											가입하여 회사 홈페이지가 제공하는 서비스를 받는 자를 말합니다.</p>
										<p class="pri_tit" id="quick_02">제 2장 회원 관리 및 서비스</p>
										<ol class="pri_con pri_con2 mb40">
											<li><span id="quick_02_01">1. 회원 <span class="en">ID</span>와
													비밀번호
											</span>
												<ul>
											...
											<li><span id="quick_02_02">2. 회원 탈퇴</span>
												<ol>
													<li>1. 회원은 탈퇴를 희망하는 경우, <span class="en">my</span>
														스타벅스 페이지에서 “회원 탈퇴” 버튼을 통해 탈퇴 신청을 합니다.
														<ul>
															<li>-스타벅스 기명식 선불 충전카드를 보유한 고객의 카드가 잔액이 남아 있고 정지 상태에
																있는 회원의 경우, 카드의 환불 및 환급 등의 처리 절차가 모두 완료된 다음에 탈퇴할 수 있습니다.</li>
															<li>-스타벅스 <span class="en">e</span>-프리퀀시 이벤트 기간 중 탈퇴
																시에는 적립 된 <span class="en">e</span>-스티커가 모두 소멸됩니다.
															</li>
														</ul>
													</li>
												</ol></li>
					...
					<!-- <div id="mCSB_1_scrollbar_vertical"
						...
						<div class="mCSB_draggerContainer">
							<div id="mCSB_1_dragger_vertical" class="mCSB_dragger"
								style="position: absolute; min-height: 33px; top: 0px; display: block; height: 3px; max-height: 118px;"
...
<!-- 
							...
							<div id="popWrap">
								...
								<div id="container">
									...
									<!-- 개인정보의 수집 및 이용목적 내용 -->
									<div class="privacy_cont">
										<p class="mb15">본인은 (주)스타벅스커피코리아(이하 ‘회사’라 합니다)가 제공하는 회원
											서비스(이하 ‘서비스’라 합니다)를 이용하기 위해, 다음과 같이 ‘회사’가 본인의 개인정보를 수집/이용하고,
											개인정보의 취급을 위탁하는 것에 동의합니다.</p>
		...
		<section class="mem_join_note">
			...
			<ul>
				...
				<li>· 스타벅스커피 코리아의 공식 홈페이지는 Internet Explorer 9.0 이상, Chrome,
		...
		<section class="mem_accreditation_wrap mb10">
			...
			<div class="mem_accreditation_info">
				<div class="li1">
					<figure>
						<img
							src="<c:url value='/ProjectLogin/img_100_1.png'/>"
							alt="휴대폰 아이콘">
					</figure>
					<p class="mem_k_titl">휴대폰 인증</p>
					<p class="mem_k_txt">본인 명의의 휴대폰을 통해<br/> 인증합니다.</p>
					<p class="mem_k_btn">
						<a href="javascript:void(0)" title="휴대폰 본인 인증 새창열기">인증하기</a>
					</p>
				</div>
				<div class="li2">
					<figure>
					...
					<p class="mem_f_txt">가입한 아이핀 ID를 통해<br/> 인증합니다.</p>
					<p class="mem_f_btn">
